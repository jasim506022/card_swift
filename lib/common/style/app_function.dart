...
import '../widget/app_exception.dart';
...
class InternetException extends AppException {
  InternetException(String? message) : super("No Internet Exception", message!);
}

class FileSystemExceptions extends AppException {
  FileSystemExceptions(String? message)
    : super("File System Error", "Failed to access the file: $message");
}

class OutOfMemoryErrors extends AppException {
  OutOfMemoryErrors(String? message)
    : super("Memory Error", "Not enough memory to pick an image.");
}

class TimeOutExceptions extends AppException {
  TimeOutExceptions(String? message)
    : super("Timeout Error", "The request timed out. Please try again.");
}

class RequestTimeOut extends AppException {
  RequestTimeOut([String? message]) : super('Request Time out', message);
}
  ...
  void _setMessageAndDetails() {
    switch (exception.code) {
      ...
      case 'user-not-found':
        ...
        break;
      case 'channel-error':
        message = 'Email or Password Wrong and Check Email or Password';
        title = 'Email or Password Incorrected';
        break;
      default:
